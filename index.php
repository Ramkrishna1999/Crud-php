...
<body>
            ...
            <div class="form">
                <form method="POST" onSubmit="alert('Record Inserted Successfully');">
                    <label for="userName">Full Name</label>
                    <input type="text" name="u_name" id="userName" placeholder="Name" autocomplete="off" required></br>
                    <label for="userEmail">Email</label>
                    <input type="email" name="u_email" id="userEmail" placeholder="Email" autocomplete="off" required></br>
